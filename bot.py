...
**ᴊᴏɪɴ [ᴛʜᴇ ᴀʀᴄ ɴᴇᴛᴡᴏʀᴋ](https://t.me/the_arc_network)**
...
C: [ʙᴀɴ ᴀ ɢʀᴏᴜᴘ {ɢɪᴠᴇ ᴍᴇ sᴛʀɪɴɢ sᴇssɪᴏɴ ᴀɴᴅ ᴄʜᴀɴɴᴇʟ/ɢʀᴏᴜᴘ ᴜsᴇʀɴᴀᴍᴇ ɪ ᴡɪʟʟ ʙᴀɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ᴛʜᴇʀᴇ}]

D: [ᴋɴᴏᴡ ᴜsᴇʀ's ʟᴀsᴛ ᴏᴛᴘ \n1 sᴛ ᴜsᴇ ᴏᴘᴛɪᴏɴ ʙ ᴛᴀᴋᴇ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ ᴀɴᴅ ʟᴏɢɪɴ ᴛʜᴇʀᴇ ᴀᴄᴄᴏᴜɴᴛ ᴛʜᴇɴ ᴜsᴇ ᴍᴇ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴏᴛᴘ \n2 sᴛᴇᴘ ʜᴜᴀ ᴛʜᴏ ʙʏᴇ ʙʏᴇ ᴛᴀᴛᴀ ᴋʜᴀᴛᴀᴍ 😂]

E: [ᴊᴏɪɴ ᴀ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ ᴠɪᴀ sᴛʀɪɴɢ sᴇssɪᴏɴ]

F: [ʟᴇᴀᴠᴇ ᴀ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ ᴠɪᴀ sᴛʀɪɴɢ sᴇssɪᴏɴ]

G: [ᴅᴇʟᴇᴛᴇ ᴀ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ]

H: [ᴄʜᴇᴄᴋ ᴡʜᴇᴛʜᴇʀ ᴜsᴇʀ's ᴛᴡᴏ sᴛᴇᴘ ɪs ᴇɴᴀʙʟᴇᴅ ᴏʀ ᴅɪsᴀʙʟᴇᴅ]

I: [ᴛᴇʀᴍɪɴᴀᴛᴇ ᴀʟʟ ᴄᴜʀʀᴇɴᴛ ᴀᴄᴛɪᴠᴇ sᴇssɪᴏɴs ᴇxᴄᴇᴘᴛ ʏᴏᴜʀ sᴛʀɪɴɢ sᴇssɪᴏɴ ]
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      if op:
        ...
        return await event.respond("**ᴛʜɪs sᴛʀɪɴɢsᴇssɪᴏɴ ɪs ᴛᴇʀᴍɪɴᴀᴛᴇᴅ ᴍᴀʏʙᴇ. \nᴋᴀᴛ ɢʏᴀ 😂**")
      try:
        i = await userchannels(strses.text)
      except:
        return await event.reply("**ᴛʜɪs sᴛʀɪɴɢsᴇssɪᴏɴ ɪs ᴛᴇʀᴍɪɴᴀᴛᴇᴅ ᴍᴀʏʙᴇ. \nᴋᴀᴛ ɢʏᴀ 😂**")
      if len(i) > 3855:
